		...
		<div class = "layui-container">
			<div class = "layui-row">
				...
				<div class = "layui-col-lg12">
					Copyright © 2017-2022 Powered by <a href="https://www.shui.tk/" target = "_blank" title = "ImgURL是一个开源免费的图床程序">ImgURL</a> | Author <a href="https://www.shui.tk/" target = "_blank" title = "水啊博客">shuia</a>
					<!-- 简单判断用户是否登录 -->

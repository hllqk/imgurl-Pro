...
c = conn.cursor()
#查询10张没有压缩的图片
imgs = c.execute("SELECT a.path,a.compression,b.mime,b.ext,a.id FROM img_images AS a INNER JOIN img_imginfo b ON a.storage = 'localhost' AND a.imgid = b.imgid AND a.compression = 0 ORDER BY a.id DESC LIMIT 10")
